...
namespace QuanLyGameConsole.Areas.Admin.Controllers
{
    ...
    public class BillController : Controller
    {
        ...
        public BillController(GameConsoleContext context)
        {
            _context = context;
        }
        ...
        {
            var gameConsoleContext = _context.Bills.Include(b => b.Customer);
        ...
        public async Task<IActionResult> Create([Bind("BillId,CustomerId,OrderDate,FullName,Phone,Email,Address,PaymentMethod,Total,Note,Status")] Bill bill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BillId,CustomerId,OrderDate,FullName,Phone,Email,Address,PaymentMethod,Total,Note,Status")] Bill bill)
        {
            if (id != bill.BillId)
            {
                return NotFound();
